A simple one-page (literally, just one html file with scripts inline) application using AngularJS to asynchronously calculate basic hash values given a single input.
